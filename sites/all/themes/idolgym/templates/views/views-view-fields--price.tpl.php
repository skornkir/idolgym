    ...
    <div class="price">
        ...
        <div class="body">
            <div class="b-group-card__cont">
                ...
                <div class="b-unlim-card__cont__row">
                            <?php print $fields['field_count_workout']->content ; ?>
                </div>
                <div class="b-unlim-card__cont__row"><i><b>Заморозка</b></i> включено</div>
                <a href="#" class="btn form_price_btn" data-toggle="modal" data-target="#exampleModal">Купить</a>
