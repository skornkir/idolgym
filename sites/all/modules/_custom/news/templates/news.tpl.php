...
<div class="prices">
    <div class="collapse show" id="seven_days">
        <?php
            print views_embed_view('price', 'block_1')
        ?>
    </div>
    <div class="collapse" id="three_days">
        <?php
            print views_embed_view('price', 'block_2')
        ?>
    </div>
    <div class="collapse" id="nine_days">
        <?php
          print views_embed_view('price', 'block_3')
        ?>
    </div>
    <div class="collapse" id="weekend_days">
        <?php
             print views_embed_view('price', 'block_4')
        ?>
    </div>
    <div class="collapse" id="family_daya">
        <?php
            print views_embed_view('price', 'block_5')
        ?>
    </div>

    <div class="collapse" id="student_days">
       <?php
            print views_embed_view('price', 'block_6')
        ?>
    </div>
</div>
